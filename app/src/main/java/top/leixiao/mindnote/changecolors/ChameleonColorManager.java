package top.leixiao.mindnote.changecolors;
...
public class ChameleonColorManager implements OnChangeColorListener, OnChangeColorListenerWithParams {
    ...
    public void init() {
        ...
        if (cursor == null || !cursor.moveToFirst()) {
            ...
            sStatusbarBackgroudColorS1 = getColorFromCursor(cursor, ColorConfigConstants.STATUSBAR_BACKGROUND_COLOR_S1, ColorConfigConstants.DEFAULT_SYSTEM_NAVIGATION_BACKGROUND_COLOR_S2);
            ...
            sIsPowerSavingMode = getColorFromCursor(cursor, ColorConfigConstants.ID, 1) == 2;
