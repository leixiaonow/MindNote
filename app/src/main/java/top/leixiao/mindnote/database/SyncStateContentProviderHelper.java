...
public class SyncStateContentProviderHelper {
    ...
    private static final String[] ACCOUNT_PROJECTION = new String[]{NotePaper.AccountConstract.ACCOUNT_NMAE, "account_type"};
    ...
    public long insert(SQLiteDatabase db, ContentValues values) {
        return db.replace(SYNC_STATE_TABLE, NotePaper.AccountConstract.ACCOUNT_NMAE, values);
    }
